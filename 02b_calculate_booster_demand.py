...
area_results_booster_path = (
    f"building_analysis/results/{sim}_{size}/area_results_{sim}.csv"
)
...
folder_area_results_path = f"building_analysis/results/{sim}_{size}/area_results"
os.makedirs(folder_area_results_path, exist_ok=True)

area_results_booster_path = (
    f"building_analysis/results/{sim}_{size}/area_results/area_results_{sim}_{size}.csv"
)
