...
if __name__ == "__main__":
    ...
    # type of simulation
    sim = "unrenovated"
    building_types = "whole_buildingstock"

    # Directories for saving results
    dir_dhw_volumes = f"building_analysis/results/{sim}_{building_types}/dhw_volumes"
    dir_dhw_energy = f"building_analysis/results/{sim}_{building_types}/dhw_energy"
    dir_space_heating = (
        f"building_analysis/results/{sim}_{building_types}/space_heating"
    )
    ...
    area_results.to_csv(
        f"building_analysis/results/{sim}_{building_types}/area_results.csv"
    )
