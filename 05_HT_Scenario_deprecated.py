...
# let's import the relevant data first. In this scenario the Buildingstock is unrenovated
...
for idx, row in npv_data.iterrows():
    ...
    npv_renovated = npv(0, energy_costs_new, income_buildings, building_interest_rate)
    npv_data.loc[
        idx,
