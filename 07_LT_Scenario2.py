...
path_embers = grid_results_parquet("renovated")
...
unrenovated_buildingstock_path = buildingstock_results_path("unrenovated")
...
plt.tight_layout()
# plt.show()
os.makedirs(PLOTS_DIR / "LowTemperature", exist_ok=True)
plt.savefig(
    PLOTS_DIR / "LowTemperature" / f"LowTemperature_AverageSavings_reduction_factor_{reduction_factor}_dhg_lifetime_{dhg_lifetime}.png"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    PLOTS_DIR / "LowTemperature" / f"LowTemperature_SavingsDistribution_reduction_factor_{reduction_factor}_dhg_lifetime_{dhg_lifetime}.png"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    PLOTS_DIR / "LowTemperature" / f"LowTemperature_EnergySavingsVsNFA_reduction_factor_{reduction_factor}_dhg_lifetime_{dhg_lifetime}.png"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    PLOTS_DIR / "LowTemperature" / f"LowTemperature_SavingsAverage_reduction_factor_{reduction_factor}_dhg_lifetime_{dhg_lifetime}.png"
)
plt.close()
...
export_path = PLOTS_DIR / "LowTemperature" / f"data_exports_{reduction_factor}_dhg_lifetime_{dhg_lifetime}"
...
plt.tight_layout()
plt.savefig(
    PLOTS_DIR / "LowTemperature" / f"LowTemperature_specific_ued_dhg_lifetime_{dhg_lifetime}_reduction_factor_{reduction_factor}.png"
)
